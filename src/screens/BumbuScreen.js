      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={categoryStyles.headerSection}>
          <Text style={categoryStyles.categoryTitle}>
            Kategori <Text style={categoryStyles.boldGreen}>Bumbu</Text>
          </Text>
          <Text style={categoryStyles.headerSubtitle}>Bumbu pilihan untuk masakan sempurna Anda</Text>
        </View>
        ...
        {loading ? (
          ...
          <View style={categoryStyles.emptyContainer}>
            <Ionicons name="flask-outline" size={60} color="#DDD" />
            <Text style={categoryStyles.emptyText}>Bumbu tidak tersedia saat ini</Text>
          </View>
        )}
      </View>
